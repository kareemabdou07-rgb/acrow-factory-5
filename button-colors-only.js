...
function isMainButton(b){var t=textOf(b);return /طباعة التقارير|إدارة الأعطال|الخطة الشهرية|التعديل|تسجيل الإنتاج|أسباب نقص الكفاءة|الصيانة|تقييم 5S والسيفتي/.test(t);}
...
var s=document.createElement('script');s.src='./five-s-safety-evaluation.js?v=3';s.async=false;document.head.appendChild(s);
})();