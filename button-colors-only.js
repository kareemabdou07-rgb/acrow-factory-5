...
/* v27 — 5S/Safety evaluation restored */
(function(){
'use strict';
var activeText='';
...
function loadSafety(){if(document.getElementById('fss-loader'))return;var s=document.createElement('script');s.id='fss-loader';s.src='./five-s-safety-evaluation.js?v=27';s.async=false;document.head.appendChild(s);}
