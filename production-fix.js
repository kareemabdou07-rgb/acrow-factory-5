...
function decorateMerged(){keepMachineLists();decorate();try{if(typeof rebuildMachines==='function')rebuildMachines();}catch(e){}setTimeout(function(){mergeMachineOptions();},50);setTimeout(function(){mergeMachineOptions();},300);}
