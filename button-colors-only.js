...
/* v30 — 5S/Safety evaluation cache-busted */
(function(){
'use strict';
var activeText='';
...
function loadSafety(){if(document.getElementById('fss-loader'))return;var s=document.createElement('script');s.id='fss-loader';s.src='./five-s-safety-evaluation.js?v=30';s.async=false;document.head.appendChild(s);}
