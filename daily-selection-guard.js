/* ACROW Factory 5 — v225 daily selection guard; last five remain fully manual */
(function(){
'use strict';
var BACKUP_KEY='acrowFactory5_critical_backup_v1';
var MANUAL_IDS=['2','8','9','10','forming-frame'];
function sid(v){return String(v==null?'':v).trim();}
function isManual(id){return MANUAL_IDS.indexOf(sid(id))>=0;}
...
function restoreBackup(){
  try{
    ...
    Object.keys(b.records||{}).forEach(function(k){
      ...
      if(x.actual!==undefined&&x.actual!==null&&x.actual!==''&&(!old.actual||newTime>=oldTime))store.records[k]=Object.assign({},old,x);
    });
