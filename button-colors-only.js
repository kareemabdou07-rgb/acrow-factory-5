...
/* v31 — 5S/Safety beside fault entry + report preview */
(function(){
'use strict';
var activeText='';
...
function isMainButton(b){var t=textOf(b);return /طباعة التقارير|إدارة الأعطال|الخطة الشهرية|التعديل|تسجيل الإنتاج|أسباب نقص الكفاءة|الصيانة|تقييم 5S والسلامة|تقارير 5S والسلامة/.test(t);}
...
function loadSafety(){var old=document.getElementById('fss-loader');if(old)old.remove();var s=document.createElement('script');s.id='fss-loader';s.src='./five-s-safety-evaluation.js?v=31';s.async=false;document.head.appendChild(s);}
